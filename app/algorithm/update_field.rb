class UpdateField
	...
	def calculate
	    ...
	    @statement.vs_transactions = @records[0] / @statement.vmd_avg_ticket
	    ...
	    @statement.mc_transactions = @records[0] / @statement.vmd_avg_ticket
	    ...
	    @statement.ds_transactions = @records[0] / @statement.vmd_avg_ticket
