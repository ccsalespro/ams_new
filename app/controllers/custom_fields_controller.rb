class CustomFieldsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @custom_field.save
        format.html { redirect_to program_custom_fields_path(@program), notice: 'Custom field was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @custom_field.update(custom_field_params)
        format.html { redirect_to program_custom_fields_path(@program), notice: 'Custom field was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to program_custom_fields_path(@program), notice: 'Custom field was successfully destroyed.' }
