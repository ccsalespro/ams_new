...
class CustomFieldsControllerTest < ActionController::TestCase
  ...
  test "should create custom_field" do
    assert_difference('CustomField.count') do
      post :create, custom_field: { amount: @custom_field.amount, cost: @custom_field.cost, name: @custom_field.name, type: @custom_field.type }
    end
  ...
  test "should update custom_field" do
    patch :update, id: @custom_field, custom_field: { amount: @custom_field.amount, cost: @custom_field.cost, name: @custom_field.name, type: @custom_field.type }
    assert_redirected_to custom_field_path(assigns(:custom_field))
  end
